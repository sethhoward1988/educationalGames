...
from controllers.superintendent.SuperintendentRelieveController import *
from controllers.superintendent.SuperintendentAccountController import *
from controllers.superintendent.SuperintendentEditDistrictController import *
...
if current_person == False or 'superintendent' not in current_person.role:
    ...
    app = webapp2.WSGIApplication([
        ...
        (r'/superintendent/relieve', SuperintendentRelieve),
		(r'/superintendent/school', SuperintendentAddSchool),
        (r'/superintendent/district', SuperintendentEditDistrict),
